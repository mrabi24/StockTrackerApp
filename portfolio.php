                                ...
                                <div class="modal-body">
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small
                                                <?php echo (!empty($sIniPriceErr)) ? "class='invalid-feedback'" : "" ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small
                                                    <?php echo (!empty($bDateErr)) ? "class='invalid-feedback'" : "" ?>><?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small
                                                    <?php echo (!empty($quantityErr)) ? "class='invalid-feedback'" : "" ?>><?php
